 ...
 * 
 * Similar to https://github.com/mavlink/mavros/blob/master/mavros/src/plugins/global_position.cpp
 * 
...
public:
	...
	{ 
		...
		// general params
		gp_nh_private.param<std::string>("frame_id", frame_id, "map"); // nodehandle modified by Peixuan Shu
		gp_nh_private.param<std::string>("child_frame_id", child_frame_id, "base_link"); // nodehandle modified by Peixuan Shu
		gp_nh_private.param("rot_covariance", rot_cov, 99999.0); // nodehandle modified by Peixuan Shu
		gp_nh_private.param("gps_uere", gps_uere, 1.0); // nodehandle modified by Peixuan Shu
		gp_nh_private.param("use_relative_alt", use_relative_alt, true); // nodehandle modified by Peixuan Shu
		// tf subsection
		gp_nh_private.param("tf/send", tf_send, false); // nodehandle modified by Peixuan Shu
		gp_nh_private.param<std::string>("tf/frame_id", tf_frame_id, "map"); // nodehandle modified by Peixuan Shu
		gp_nh_private.param<std::string>("tf/global_frame_id", tf_global_frame_id, "earth");	// The global_origin should be represented as "earth" coordinate frame (ECEF) (REP 105)  // nodehandle modified by Peixuan Shu
		gp_nh_private.param<std::string>("tf/child_frame_id", tf_child_frame_id, "base_link"); // nodehandle modified by Peixuan Shu
		...
		// global origin
		gp_global_origin_pub = gp_nh.advertise<geographic_msgs::GeoPointStamped>("gp_origin", 10, true); //latched
...
public: // public by Peixuan Shu
	...
	void handle_gps_raw_int(const mavlink_message_t& msg)  // Change from mavlink cpp headers to mavlink c headers by Peixuan Shu
	{
		// Decode mavlink message. Added by Peixuan Shu
		mavlink_gps_raw_int_t raw_gps;
		mavlink_msg_gps_raw_int_decode(&msg, &raw_gps); // mavlink c lib		
	...
	void handle_gps_global_origin(const mavlink_message_t& msg)  // Change from mavlink cpp headers to mavlink c headers by Peixuan Shu
	{
		// Decode mavlink message. Added by Peixuan Shu
		mavlink_gps_global_origin_t glob_orig;
		mavlink_msg_gps_global_origin_decode(&msg, &glob_orig); // mavlink c lib	
	...
	void handle_global_position_int(const mavlink_message_t& msg)  // Change from mavlink cpp headers to mavlink c headers by Peixuan Shu
	{
		// Decode mavlink message. Added by Peixuan Shu
		mavlink_global_position_int_t gpos;
		mavlink_msg_global_position_int_decode(&msg, &gpos); // mavlink c lib		
	...
	void handle_lpned_system_global_offset(const mavlink_message_t& msg)  // Change from mavlink cpp headers to mavlink c headers by Peixuan Shu
	{
		// Decode mavlink message. Added by Peixuan Shu
		mavlink_local_position_ned_system_global_offset_t offset;
		mavlink_msg_local_position_ned_system_global_offset_decode(&msg, &offset); // mavlink c lib		
...
private:
	...
	void set_gp_origin_cb(const geographic_msgs::GeoPointStamped::ConstPtr &req)
	{
		...
		mavlink_set_gps_global_origin_t gpo {};  // use mavlink c headers by Peixuan Shu
