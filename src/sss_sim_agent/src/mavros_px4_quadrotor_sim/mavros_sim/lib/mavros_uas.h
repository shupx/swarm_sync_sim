 ...
 * @brief Simulated mavros uas.
 * 
 * Similar to https://github.com/mavlink/mavros/blob/master/mavros/include/mavros/mavros_uas.h
 * 
 ...
 * 
 * Added by Peixuan Shu (originally in mavros/include/mavros/utils.h)
 */
namespace utils{
...
public:
	...
	using CapabilitiesCb = std::function<void(MAV_PROTOCOL_CAPABILITY)>;
